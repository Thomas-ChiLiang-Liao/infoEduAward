    ...
    <?php menu('signIn'); ?>
      ...
      <div class="row mt-5">
        <div class="col-10 offset-1 col-md-8 offset-md-2 col-xl-6 offset-xl-3">
          <div class="card">
            <div class="card-header text-center bg-primary text-white"><h4>個人組報名作業</h4></div>
            <div class="card-body">
              ...
              <input type="hidden" name="table" id="table" value="person">
                ...
                <div class="input-group mt-1">
                  ...
                  <input type="text" class="form-control" placeholder="簡稱" id="school" name="school" required>
                </div>                
                <!-- 行動電話 -->
                <div class="input-group mt-1">
                  <div class="input-group-prepend">
